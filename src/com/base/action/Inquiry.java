...
{
	private static Logger logger = Logger.getLogger(Inquiry.class);
	 ...
	 * @throws Exception
	 */
	public String doInquiry(String sVoucherNo, String sRefNo, Integer iTermNo, Integer iReciept, String sAmnt) throws Exception
	{
		...
		Document xmlRequest = xmlBuild.buildInquiryRedeemXML(sVoucherNo, sRefNo, iTermNo, iReciept, sAmnt, Integer.valueOf(iStoreNo), sDate, "I");
    
		SoapHandler doRequest = new SoapHandler();
		Document xmlResponse = doRequest.sendRequest(xmlRequest);
   
		XMLParser xmlParse = new XMLParser();
		aList = xmlParse.parseInquiryRedemptionXML(xmlResponse, "Inquiry");
